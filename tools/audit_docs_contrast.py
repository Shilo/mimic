...
PAIRS = [
	...
	Pair("light drawer source text/icons", "ink", "mint"),
	Pair("light drawer source hover text/icons", "ink", "mint_hover"),
	Pair("light drawer source divider", "ink", "mint", AA_UI),
	...
	Pair("light top button hover text", "ink", "mint_hover"),
	Pair("light code button text", "ink", "soft_mint"),
	Pair("light code button border", "border_strong", "soft_mint", AA_UI),
	Pair("light code button hover text", "ink", "mint"),
	...
	Pair("light nav link text", "link_light", "page"),
	Pair("light nav active/hover text", "link_light_hover", "page"),
	...
	Pair("dark drawer source text/icons", "ink", "mint"),
	Pair("dark drawer source hover text/icons", "ink", "mint_hover"),
	Pair("dark drawer source divider", "ink", "mint", AA_UI),
