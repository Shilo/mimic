...
PAIRS = [
	...
	Pair("light content links", "mint_text", "page"),
	Pair("light content link hover", "mint_text_hover", "page"),
	...
	Pair("light secondary button text", "mint_text", "page"),
	Pair("light secondary button border", "mint_text", "page", AA_UI),
	Pair("light secondary button hover text", "mint_text_hover", "soft_mint"),
	Pair("light secondary button hover border", "mint_text_hover", "soft_mint", AA_UI),
